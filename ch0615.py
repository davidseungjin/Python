...
def get_grade_stats(scores):
	...
	return mean, std_dev	# <== default setting is a tuple container

	# equivalent statement is return (mean, std_dev)
	# the return output can be a list container, 
	# in the case, expression is return [mean, std_dev]
	# return a, b, [c, d] is possible. 
	# If then, it means (a, b, [c, d]) tuple.
...
print('Average score:', '%0.2f' % average)
print('Standard deviation:', '%0.2f' % standard_deviation)
print('id average: ', id(average))
print('id std: ', id(standard_deviation))
#print('id mean: ', id(mean))
#print('id std_dev: ', id(std_dev))
